...
if(isset($_POST["edit"]) ){
  ...
  $result = mysqli_query($connect, "UPDATE products SET prod_name ='$newName' WHERE prod_id='$prodId' AND id ='$user_id'");
  $result = mysqli_query($connect, "UPDATE products SET prod_price ='$newPrice' WHERE prod_id='$prodId' AND id ='$user_id'");  
...
if(isset($_POST["del"]) ){
  $user_id = $_SESSION["user"]["id"];
  $id = $_POST["id"];
  $result=mysqli_query($connect, "DELETE FROM products WHERE prod_id='$id' AND id ='$user_id'");
  if($_SESSION["user"]["name"] == "Admin"){
    $result=mysqli_query($connect, "DELETE FROM products WHERE prod_id='$id'");
  }
}
...
$query="INSERT INTO products VALUES(null,\"".$_POST["name"]."\",".$_POST["cena"].",\"".$_FILES["filename"]["name"]."\",\"".$_SESSION["user"]["id"]."\" )";
...
$result=mysqli_query($connect, "SELECT * FROM products WHERE id='$id' ORDER BY prod_price ");
if($_SESSION["user"]["name"] == "Admin"){
